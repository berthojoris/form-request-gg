...
<div class="page-content">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button type="submit" class="btn btn-primary"><i class="icon wb-search"
        ...
        <div class="panel-body container-fluid">
            <div class="row row-lg">
                            ...
                            <div class="input-group">
                                <div class="input-group-btn">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        ...
                                        <a class="dropdown-item" href="javascript:void(0)" role="menuitem">Another
                                            action</a>
                                        <a class="dropdown-item" href="javascript:void(0)" role="menuitem">Something
                                            else here</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="javascript:void(0)" role="menuitem">Separated
                                            link</a>
                                    </div>
                                </div>
                                <input type="text" class="form-control">
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="example-wrap">
                        <h4 class="example-title">Size</h4>
                        <p>Add the relative form sizing classes to the <code>.input-group</code> itself and
                            contents within will automatically resize—no need
    ...
    <div class="panel form-icons">
        <div class="panel-heading">
            <h3 class="panel-title">Form icons</h3>
        </div>
        <div class="panel-body container-fluid">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="example-warp">
                        ...
                        <div class="example round-input-control">
                            <div class="input-group">
                                <i class="form-control-icon wb-map"></i>
                                <input class="form-control" type="text" name="round-input-control"
                                    placeholder="round-input-control">
                            </div>
                        </div>
                    </div>
                </div>
